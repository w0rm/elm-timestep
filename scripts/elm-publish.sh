...
sed -i.bak "s+https://unsoundscapes.com/elm-timestep/+https://unsoundscapes.com/elm-timestep/$version/+g" README.md
sed -i.bak "s+https://github.com/w0rm/elm-timestep/tree/main/+https://github.com/w0rm/elm-timestep/tree/$last_commit/+g" README.md
rm README.md.bak
git add README.md
